        ...
        <div className="container" id='pamCard'>
            <div className="row d-flex align-items-center">
                ...
                <div className="col">
                    ...
                    <p className="pamSocial">
                    <div>
                        <a class="fab fa-twitter" href="http://twitter.com/PamGBoyd" target="_blank"></a>
                    </div>
                    <div>
                        <a class="fab fa-blogger" href="https://pamboyd.wordpress.com/" target="_blank"></a>
                    </div>
                    </p>
                </div>
            </div>
